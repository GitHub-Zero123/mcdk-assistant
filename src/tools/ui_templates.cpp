...
static UiTemplateResult gen_screen_basic(const std::string& ns, const std::string& mod) {
    ...
    std::string json =
        ...
        "      {\n"
        "        \"panel\": {\n"
        "          \"type\": \"panel\", \"size\": [\"120%y+0px\", \"80%\"], \"anchor_from\": \"center\", \"anchor_to\": \"center\", \"layer\": 1,\n"
        "          \"controls\": [\n"
        "            {\n"
        "              \"workPanel\": {\n"
        ...
        "                      \"size\": [\"100%\", \"5%y+0px\"], \"anchor_from\": \"top_middle\", \"anchor_to\": \"top_middle\",\n"
        "                      \"controls\": [\n"
        "                        { \"label\": { \"type\": \"label\", \"text\": \"" + ns + "\", \"color\": [1,1,1], \"font_scale_factor\": 1.2, \"size\": [\"fill\", \"100%\"] } },\n"
        "                        {\n"
        "                          \"closeBtn@common.button\": {\n"
        "                            \"size\": [\"5%y+0px\", \"100%\"],\n"
        "                            \"$pressed_button_name\": \"button.close\",\n"
        "                            \"controls\": [\n"
        "                              { \"icon\": { \"type\": \"image\", \"size\": [\"80%\", \"80%\"], \"texture\": \"textures/ui/cancel\" } }\n"
        "                            ]\n"
        "                          }\n"
        "                        }\n"
        "                      ]\n"
...
static UiTemplateResult gen_screen_grid(const std::string& ns, const std::string& mod) {
    ...
    std::string json =
        ...
        "    \"type\": \"panel\",\n"
        "    \"controls\": [\n"
        "      { \"icon\": { \"type\": \"image\", \"size\": [\"90%\", \"90%\"], \"anchor_from\": \"center\", \"anchor_to\": \"center\", \"texture\": \"textures/ui/cell_image_normal\" } }\n"
        "    ]\n"
        "  },\n"
        "  \"main\": {\n"
        "    \"type\": \"screen\", \"size\": [\"100%\", \"100%\"],\n"
...
static UiTemplateResult gen_screen_form(const std::string& ns, const std::string& mod) {
    ...
    std::string json =
        ...
        "      {\n"
        "        \"panel\": {\n"
        "          \"type\": \"panel\", \"size\": [\"80%y+0px\", \"50%\"], \"anchor_from\": \"center\", \"anchor_to\": \"center\", \"layer\": 1,\n"
        "          \"controls\": [\n"
        "            {\n"
        "              \"form\": {\n"
        ...
        "                      \"controls\": [\n"
        "                        { \"button_label\": { \"type\": \"label\", \"text\": \"确认\", \"color\": [1,1,1], \"layer\": 3 } }\n"
        "                      ]\n"
        "                    }\n"
        "                  }\n"
        "                ]\n"
...
static UiTemplateResult gen_screen_tabbed(const std::string& ns, const std::string& mod) {
    ...
    std::string json =
        ...
        "              \"tabs\": {\n"
        "                \"type\": \"stack_panel\", \"orientation\": \"horizontal\",\n"
        "                \"size\": [\"100%\", \"5%y+0px\"], \"anchor_from\": \"top_left\", \"anchor_to\": \"top_left\",\n"
        "                \"controls\": [\n"
        "                  {\n"
        "                    \"tab0@common.button\": {\n"
        "                      \"size\": [\"50%\", \"100%\"], \"$pressed_button_name\": \"button.tab0\",\n"
        "                      \"controls\": [{ \"button_label\": { \"type\": \"label\", \"text\": \"标签1\", \"color\": [1,1,1], \"layer\": 3 } }]\n"
        "                    }\n"
        "                  },\n"
        "                  {\n"
        "                    \"tab1@common.button\": {\n"
        "                      \"size\": [\"50%\", \"100%\"], \"$pressed_button_name\": \"button.tab1\",\n"
        "                      \"controls\": [{ \"button_label\": { \"type\": \"label\", \"text\": \"标签2\", \"color\": [1,1,1], \"layer\": 3 } }]\n"
        "                    }\n"
        "                  }\n"
        "                ]\n"
        "              }\n"
...
static UiTemplateResult gen_widget_button(const std::string& ns, const std::string&) {
    std::string json =
        ...
        "      { \"button_label\": { \"type\": \"label\", \"text\": \"按钮\", \"color\": [1,1,1], \"layer\": 3 } }\n"
        "    ]\n"
        "  }\n"
        "}";
    return {json, "", "", ""};
