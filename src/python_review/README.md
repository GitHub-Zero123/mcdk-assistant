...
| `logic-blob.large-function` | risk / warning | advisory-verify | 2 | 单函数行跨度 ≥55→risk、≥100→warning | 事件分发 / UI 回调类的长函数,可酌情放过 |
...
| `thresholds.func_loc` / `func_loc_high` | `55` / `100` | 单函数偏长 / 过长行数 |
