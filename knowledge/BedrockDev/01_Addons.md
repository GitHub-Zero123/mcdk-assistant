...
| minecraft:acacia_door:000 | minecraft:acacia_door | 0 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:001 | minecraft:acacia_door | 1 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:002 | minecraft:acacia_door | 2 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:003 | minecraft:acacia_door | 3 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:004 | minecraft:acacia_door | 4 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:005 | minecraft:acacia_door | 5 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:006 | minecraft:acacia_door | 6 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:007 | minecraft:acacia_door | 7 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:008 | minecraft:acacia_door | 8 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:009 | minecraft:acacia_door | 9 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:010 | minecraft:acacia_door | 10 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:011 | minecraft:acacia_door | 11 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:012 | minecraft:acacia_door | 12 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:013 | minecraft:acacia_door | 13 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:014 | minecraft:acacia_door | 14 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:015 | minecraft:acacia_door | 15 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:016 | minecraft:acacia_door | 16 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:017 | minecraft:acacia_door | 17 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:018 | minecraft:acacia_door | 18 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:019 | minecraft:acacia_door | 19 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:acacia_door:020 | minecraft:acacia_door | 20 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:021 | minecraft:acacia_door | 21 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:022 | minecraft:acacia_door | 22 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:023 | minecraft:acacia_door | 23 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:acacia_door:024 | minecraft:acacia_door | 24 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:025 | minecraft:acacia_door | 25 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:026 | minecraft:acacia_door | 26 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:027 | minecraft:acacia_door | 27 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:acacia_door:028 | minecraft:acacia_door | 28 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:029 | minecraft:acacia_door | 29 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:030 | minecraft:acacia_door | 30 | minecraft:acacia_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_door:031 | minecraft:acacia_door | 31 | minecraft:acacia_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:acacia_fence_gate:000 | minecraft:acacia_fence_gate | 0 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:acacia_fence_gate:001 | minecraft:acacia_fence_gate | 1 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:acacia_fence_gate:002 | minecraft:acacia_fence_gate | 2 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:acacia_fence_gate:003 | minecraft:acacia_fence_gate | 3 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:acacia_fence_gate:004 | minecraft:acacia_fence_gate | 4 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:acacia_fence_gate:005 | minecraft:acacia_fence_gate | 5 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:acacia_fence_gate:006 | minecraft:acacia_fence_gate | 6 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:acacia_fence_gate:007 | minecraft:acacia_fence_gate | 7 | minecraft:acacia_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:acacia_fence_gate:008 | minecraft:acacia_fence_gate | 8 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:acacia_fence_gate:009 | minecraft:acacia_fence_gate | 9 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:acacia_fence_gate:010 | minecraft:acacia_fence_gate | 10 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:acacia_fence_gate:011 | minecraft:acacia_fence_gate | 11 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:acacia_fence_gate:012 | minecraft:acacia_fence_gate | 12 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:acacia_fence_gate:013 | minecraft:acacia_fence_gate | 13 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:acacia_fence_gate:014 | minecraft:acacia_fence_gate | 14 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:acacia_fence_gate:015 | minecraft:acacia_fence_gate | 15 | minecraft:acacia_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:anvil:004 | minecraft:anvil | 4 | minecraft:chipped_anvil ["minecraft:cardinal_direction" = "south"] |
| minecraft:anvil:005 | minecraft:anvil | 5 | minecraft:chipped_anvil ["minecraft:cardinal_direction" = "west"] |
| minecraft:anvil:006 | minecraft:anvil | 6 | minecraft:chipped_anvil ["minecraft:cardinal_direction" = "north"] |
| minecraft:anvil:007 | minecraft:anvil | 7 | minecraft:chipped_anvil ["minecraft:cardinal_direction" = "east"] |
| minecraft:anvil:008 | minecraft:anvil | 8 | minecraft:damaged_anvil ["minecraft:cardinal_direction" = "south"] |
| minecraft:anvil:009 | minecraft:anvil | 9 | minecraft:damaged_anvil ["minecraft:cardinal_direction" = "west"] |
| minecraft:anvil:010 | minecraft:anvil | 10 | minecraft:damaged_anvil ["minecraft:cardinal_direction" = "north"] |
| minecraft:anvil:011 | minecraft:anvil | 11 | minecraft:damaged_anvil ["minecraft:cardinal_direction" = "east"] |
| minecraft:anvil:012 | minecraft:anvil | 12 | minecraft:deprecated_anvil ["minecraft:cardinal_direction" = "south"] |
| minecraft:anvil:013 | minecraft:anvil | 13 | minecraft:deprecated_anvil ["minecraft:cardinal_direction" = "west"] |
| minecraft:anvil:014 | minecraft:anvil | 14 | minecraft:deprecated_anvil ["minecraft:cardinal_direction" = "north"] |
| minecraft:anvil:015 | minecraft:anvil | 15 | minecraft:deprecated_anvil ["minecraft:cardinal_direction" = "east"] |
...
| minecraft:birch_door:000 | minecraft:birch_door | 0 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:001 | minecraft:birch_door | 1 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:002 | minecraft:birch_door | 2 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:003 | minecraft:birch_door | 3 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:004 | minecraft:birch_door | 4 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:005 | minecraft:birch_door | 5 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:006 | minecraft:birch_door | 6 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:007 | minecraft:birch_door | 7 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:008 | minecraft:birch_door | 8 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:009 | minecraft:birch_door | 9 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:010 | minecraft:birch_door | 10 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:011 | minecraft:birch_door | 11 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:012 | minecraft:birch_door | 12 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:013 | minecraft:birch_door | 13 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:014 | minecraft:birch_door | 14 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:015 | minecraft:birch_door | 15 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:016 | minecraft:birch_door | 16 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:017 | minecraft:birch_door | 17 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:018 | minecraft:birch_door | 18 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:019 | minecraft:birch_door | 19 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:birch_door:020 | minecraft:birch_door | 20 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:021 | minecraft:birch_door | 21 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:022 | minecraft:birch_door | 22 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:023 | minecraft:birch_door | 23 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:birch_door:024 | minecraft:birch_door | 24 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:025 | minecraft:birch_door | 25 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:026 | minecraft:birch_door | 26 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:027 | minecraft:birch_door | 27 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:birch_door:028 | minecraft:birch_door | 28 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:029 | minecraft:birch_door | 29 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:030 | minecraft:birch_door | 30 | minecraft:birch_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_door:031 | minecraft:birch_door | 31 | minecraft:birch_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:birch_fence_gate:000 | minecraft:birch_fence_gate | 0 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:birch_fence_gate:001 | minecraft:birch_fence_gate | 1 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:birch_fence_gate:002 | minecraft:birch_fence_gate | 2 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:birch_fence_gate:003 | minecraft:birch_fence_gate | 3 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:birch_fence_gate:004 | minecraft:birch_fence_gate | 4 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:birch_fence_gate:005 | minecraft:birch_fence_gate | 5 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:birch_fence_gate:006 | minecraft:birch_fence_gate | 6 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:birch_fence_gate:007 | minecraft:birch_fence_gate | 7 | minecraft:birch_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:birch_fence_gate:008 | minecraft:birch_fence_gate | 8 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:birch_fence_gate:009 | minecraft:birch_fence_gate | 9 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:birch_fence_gate:010 | minecraft:birch_fence_gate | 10 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:birch_fence_gate:011 | minecraft:birch_fence_gate | 11 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:birch_fence_gate:012 | minecraft:birch_fence_gate | 12 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:birch_fence_gate:013 | minecraft:birch_fence_gate | 13 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:birch_fence_gate:014 | minecraft:birch_fence_gate | 14 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:birch_fence_gate:015 | minecraft:birch_fence_gate | 15 | minecraft:birch_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:chemistry_table:000 | minecraft:chemistry_table | 0 | minecraft:compound_creator ["direction" = 0] |
| minecraft:chemistry_table:001 | minecraft:chemistry_table | 1 | minecraft:compound_creator ["direction" = 1] |
| minecraft:chemistry_table:002 | minecraft:chemistry_table | 2 | minecraft:compound_creator ["direction" = 2] |
| minecraft:chemistry_table:003 | minecraft:chemistry_table | 3 | minecraft:compound_creator ["direction" = 3] |
...
| minecraft:cobblestone_wall:010 | minecraft:cobblestone_wall | 10 | minecraft:end_stone_brick_wall |
...
| minecraft:coral_block:001 | minecraft:coral_block | 1 | minecraft:brain_coral_block |
...
| minecraft:coral_fan:007 | minecraft:coral_fan | 7 | minecraft:tube_coral_fan ["coral_fan_direction" = 0] |
...
| minecraft:coral_fan_dead:000 | minecraft:coral_fan_dead | 0 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:001 | minecraft:coral_fan_dead | 1 | minecraft:dead_brain_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:002 | minecraft:coral_fan_dead | 2 | minecraft:dead_bubble_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:003 | minecraft:coral_fan_dead | 3 | minecraft:dead_fire_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:004 | minecraft:coral_fan_dead | 4 | minecraft:dead_horn_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:005 | minecraft:coral_fan_dead | 5 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:006 | minecraft:coral_fan_dead | 6 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:007 | minecraft:coral_fan_dead | 7 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 0] |
| minecraft:coral_fan_dead:008 | minecraft:coral_fan_dead | 8 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:009 | minecraft:coral_fan_dead | 9 | minecraft:dead_brain_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:010 | minecraft:coral_fan_dead | 10 | minecraft:dead_bubble_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:011 | minecraft:coral_fan_dead | 11 | minecraft:dead_fire_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:012 | minecraft:coral_fan_dead | 12 | minecraft:dead_horn_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:013 | minecraft:coral_fan_dead | 13 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:014 | minecraft:coral_fan_dead | 14 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_dead:015 | minecraft:coral_fan_dead | 15 | minecraft:dead_tube_coral_fan ["coral_fan_direction" = 1] |
| minecraft:coral_fan_hang2:000 | minecraft:coral_fan_hang2 | 0 | minecraft:bubble_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang2:001 | minecraft:coral_fan_hang2 | 1 | minecraft:fire_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang2:002 | minecraft:coral_fan_hang2 | 2 | minecraft:dead_bubble_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang2:003 | minecraft:coral_fan_hang2 | 3 | minecraft:dead_fire_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang2:004 | minecraft:coral_fan_hang2 | 4 | minecraft:bubble_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang2:005 | minecraft:coral_fan_hang2 | 5 | minecraft:fire_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang2:006 | minecraft:coral_fan_hang2 | 6 | minecraft:dead_bubble_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang2:007 | minecraft:coral_fan_hang2 | 7 | minecraft:dead_fire_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang2:008 | minecraft:coral_fan_hang2 | 8 | minecraft:bubble_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang2:009 | minecraft:coral_fan_hang2 | 9 | minecraft:fire_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang2:010 | minecraft:coral_fan_hang2 | 10 | minecraft:dead_bubble_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang2:011 | minecraft:coral_fan_hang2 | 11 | minecraft:dead_fire_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang2:012 | minecraft:coral_fan_hang2 | 12 | minecraft:bubble_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang2:013 | minecraft:coral_fan_hang2 | 13 | minecraft:fire_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang2:014 | minecraft:coral_fan_hang2 | 14 | minecraft:dead_bubble_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang2:015 | minecraft:coral_fan_hang2 | 15 | minecraft:dead_fire_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang3:000 | minecraft:coral_fan_hang3 | 0 | minecraft:horn_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang3:001 | minecraft:coral_fan_hang3 | 1 | minecraft:horn_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang3:002 | minecraft:coral_fan_hang3 | 2 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang3:003 | minecraft:coral_fan_hang3 | 3 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang3:004 | minecraft:coral_fan_hang3 | 4 | minecraft:horn_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang3:005 | minecraft:coral_fan_hang3 | 5 | minecraft:horn_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang3:006 | minecraft:coral_fan_hang3 | 6 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang3:007 | minecraft:coral_fan_hang3 | 7 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang3:008 | minecraft:coral_fan_hang3 | 8 | minecraft:horn_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang3:009 | minecraft:coral_fan_hang3 | 9 | minecraft:horn_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang3:010 | minecraft:coral_fan_hang3 | 10 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang3:011 | minecraft:coral_fan_hang3 | 11 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang3:012 | minecraft:coral_fan_hang3 | 12 | minecraft:horn_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang3:013 | minecraft:coral_fan_hang3 | 13 | minecraft:horn_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang3:014 | minecraft:coral_fan_hang3 | 14 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang3:015 | minecraft:coral_fan_hang3 | 15 | minecraft:dead_horn_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang:000 | minecraft:coral_fan_hang | 0 | minecraft:tube_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang:001 | minecraft:coral_fan_hang | 1 | minecraft:brain_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang:002 | minecraft:coral_fan_hang | 2 | minecraft:dead_tube_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang:003 | minecraft:coral_fan_hang | 3 | minecraft:dead_brain_coral_wall_fan ["coral_direction" = 0] |
| minecraft:coral_fan_hang:004 | minecraft:coral_fan_hang | 4 | minecraft:tube_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang:005 | minecraft:coral_fan_hang | 5 | minecraft:brain_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang:006 | minecraft:coral_fan_hang | 6 | minecraft:dead_tube_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang:007 | minecraft:coral_fan_hang | 7 | minecraft:dead_brain_coral_wall_fan ["coral_direction" = 1] |
| minecraft:coral_fan_hang:008 | minecraft:coral_fan_hang | 8 | minecraft:tube_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang:009 | minecraft:coral_fan_hang | 9 | minecraft:brain_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang:010 | minecraft:coral_fan_hang | 10 | minecraft:dead_tube_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang:011 | minecraft:coral_fan_hang | 11 | minecraft:dead_brain_coral_wall_fan ["coral_direction" = 2] |
| minecraft:coral_fan_hang:012 | minecraft:coral_fan_hang | 12 | minecraft:tube_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang:013 | minecraft:coral_fan_hang | 13 | minecraft:brain_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang:014 | minecraft:coral_fan_hang | 14 | minecraft:dead_tube_coral_wall_fan ["coral_direction" = 3] |
| minecraft:coral_fan_hang:015 | minecraft:coral_fan_hang | 15 | minecraft:dead_brain_coral_wall_fan ["coral_direction" = 3] |
...
| minecraft:crimson_door:000 | minecraft:crimson_door | 0 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:001 | minecraft:crimson_door | 1 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:002 | minecraft:crimson_door | 2 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:003 | minecraft:crimson_door | 3 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:004 | minecraft:crimson_door | 4 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:005 | minecraft:crimson_door | 5 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:006 | minecraft:crimson_door | 6 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:007 | minecraft:crimson_door | 7 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:008 | minecraft:crimson_door | 8 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:009 | minecraft:crimson_door | 9 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:010 | minecraft:crimson_door | 10 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:011 | minecraft:crimson_door | 11 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:012 | minecraft:crimson_door | 12 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:013 | minecraft:crimson_door | 13 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:014 | minecraft:crimson_door | 14 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:015 | minecraft:crimson_door | 15 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:016 | minecraft:crimson_door | 16 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:017 | minecraft:crimson_door | 17 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:018 | minecraft:crimson_door | 18 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:019 | minecraft:crimson_door | 19 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:crimson_door:020 | minecraft:crimson_door | 20 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:021 | minecraft:crimson_door | 21 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:022 | minecraft:crimson_door | 22 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:023 | minecraft:crimson_door | 23 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:crimson_door:024 | minecraft:crimson_door | 24 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:025 | minecraft:crimson_door | 25 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:026 | minecraft:crimson_door | 26 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:027 | minecraft:crimson_door | 27 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:crimson_door:028 | minecraft:crimson_door | 28 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:029 | minecraft:crimson_door | 29 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:030 | minecraft:crimson_door | 30 | minecraft:crimson_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_door:031 | minecraft:crimson_door | 31 | minecraft:crimson_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:crimson_fence_gate:000 | minecraft:crimson_fence_gate | 0 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:crimson_fence_gate:001 | minecraft:crimson_fence_gate | 1 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:crimson_fence_gate:002 | minecraft:crimson_fence_gate | 2 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:crimson_fence_gate:003 | minecraft:crimson_fence_gate | 3 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:crimson_fence_gate:004 | minecraft:crimson_fence_gate | 4 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:crimson_fence_gate:005 | minecraft:crimson_fence_gate | 5 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:crimson_fence_gate:006 | minecraft:crimson_fence_gate | 6 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:crimson_fence_gate:007 | minecraft:crimson_fence_gate | 7 | minecraft:crimson_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:crimson_fence_gate:008 | minecraft:crimson_fence_gate | 8 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:crimson_fence_gate:009 | minecraft:crimson_fence_gate | 9 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:crimson_fence_gate:010 | minecraft:crimson_fence_gate | 10 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:crimson_fence_gate:011 | minecraft:crimson_fence_gate | 11 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:crimson_fence_gate:012 | minecraft:crimson_fence_gate | 12 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:crimson_fence_gate:013 | minecraft:crimson_fence_gate | 13 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:crimson_fence_gate:014 | minecraft:crimson_fence_gate | 14 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:crimson_fence_gate:015 | minecraft:crimson_fence_gate | 15 | minecraft:crimson_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:dark_oak_door:000 | minecraft:dark_oak_door | 0 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:001 | minecraft:dark_oak_door | 1 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:002 | minecraft:dark_oak_door | 2 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:003 | minecraft:dark_oak_door | 3 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:004 | minecraft:dark_oak_door | 4 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:005 | minecraft:dark_oak_door | 5 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:006 | minecraft:dark_oak_door | 6 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:007 | minecraft:dark_oak_door | 7 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:008 | minecraft:dark_oak_door | 8 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:009 | minecraft:dark_oak_door | 9 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:010 | minecraft:dark_oak_door | 10 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:011 | minecraft:dark_oak_door | 11 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:012 | minecraft:dark_oak_door | 12 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:013 | minecraft:dark_oak_door | 13 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:014 | minecraft:dark_oak_door | 14 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:015 | minecraft:dark_oak_door | 15 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:016 | minecraft:dark_oak_door | 16 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:017 | minecraft:dark_oak_door | 17 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:018 | minecraft:dark_oak_door | 18 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:019 | minecraft:dark_oak_door | 19 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:020 | minecraft:dark_oak_door | 20 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:021 | minecraft:dark_oak_door | 21 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:022 | minecraft:dark_oak_door | 22 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:023 | minecraft:dark_oak_door | 23 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:dark_oak_door:024 | minecraft:dark_oak_door | 24 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:025 | minecraft:dark_oak_door | 25 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:026 | minecraft:dark_oak_door | 26 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:027 | minecraft:dark_oak_door | 27 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:028 | minecraft:dark_oak_door | 28 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:029 | minecraft:dark_oak_door | 29 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:030 | minecraft:dark_oak_door | 30 | minecraft:dark_oak_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_door:031 | minecraft:dark_oak_door | 31 | minecraft:dark_oak_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:dark_oak_fence_gate:000 | minecraft:dark_oak_fence_gate | 0 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:001 | minecraft:dark_oak_fence_gate | 1 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:002 | minecraft:dark_oak_fence_gate | 2 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:003 | minecraft:dark_oak_fence_gate | 3 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:004 | minecraft:dark_oak_fence_gate | 4 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:005 | minecraft:dark_oak_fence_gate | 5 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:006 | minecraft:dark_oak_fence_gate | 6 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:007 | minecraft:dark_oak_fence_gate | 7 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:008 | minecraft:dark_oak_fence_gate | 8 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:009 | minecraft:dark_oak_fence_gate | 9 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:010 | minecraft:dark_oak_fence_gate | 10 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:011 | minecraft:dark_oak_fence_gate | 11 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:dark_oak_fence_gate:012 | minecraft:dark_oak_fence_gate | 12 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:013 | minecraft:dark_oak_fence_gate | 13 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:014 | minecraft:dark_oak_fence_gate | 14 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:dark_oak_fence_gate:015 | minecraft:dark_oak_fence_gate | 15 | minecraft:dark_oak_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:dirt:000 | minecraft:dirt | 0 | minecraft:dirt |
| minecraft:dirt:001 | minecraft:dirt | 1 | minecraft:coarse_dirt |
...
| minecraft:double_stone_block_slab2:000 | minecraft:double_stone_block_slab2 | 0 | minecraft:red_sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:001 | minecraft:double_stone_block_slab2 | 1 | minecraft:purpur_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:002 | minecraft:double_stone_block_slab2 | 2 | minecraft:prismarine_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:003 | minecraft:double_stone_block_slab2 | 3 | minecraft:dark_prismarine_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:004 | minecraft:double_stone_block_slab2 | 4 | minecraft:prismarine_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:005 | minecraft:double_stone_block_slab2 | 5 | minecraft:mossy_cobblestone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:006 | minecraft:double_stone_block_slab2 | 6 | minecraft:smooth_sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:007 | minecraft:double_stone_block_slab2 | 7 | minecraft:red_nether_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab2:008 | minecraft:double_stone_block_slab2 | 8 | minecraft:red_sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:009 | minecraft:double_stone_block_slab2 | 9 | minecraft:purpur_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:010 | minecraft:double_stone_block_slab2 | 10 | minecraft:prismarine_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:011 | minecraft:double_stone_block_slab2 | 11 | minecraft:dark_prismarine_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:012 | minecraft:double_stone_block_slab2 | 12 | minecraft:prismarine_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:013 | minecraft:double_stone_block_slab2 | 13 | minecraft:mossy_cobblestone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:014 | minecraft:double_stone_block_slab2 | 14 | minecraft:smooth_sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab2:015 | minecraft:double_stone_block_slab2 | 15 | minecraft:red_nether_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:000 | minecraft:double_stone_block_slab3 | 0 | minecraft:end_stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:001 | minecraft:double_stone_block_slab3 | 1 | minecraft:smooth_red_sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:002 | minecraft:double_stone_block_slab3 | 2 | minecraft:polished_andesite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:003 | minecraft:double_stone_block_slab3 | 3 | minecraft:andesite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:004 | minecraft:double_stone_block_slab3 | 4 | minecraft:diorite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:005 | minecraft:double_stone_block_slab3 | 5 | minecraft:polished_diorite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:006 | minecraft:double_stone_block_slab3 | 6 | minecraft:granite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:007 | minecraft:double_stone_block_slab3 | 7 | minecraft:polished_granite_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab3:008 | minecraft:double_stone_block_slab3 | 8 | minecraft:end_stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:009 | minecraft:double_stone_block_slab3 | 9 | minecraft:smooth_red_sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:010 | minecraft:double_stone_block_slab3 | 10 | minecraft:polished_andesite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:011 | minecraft:double_stone_block_slab3 | 11 | minecraft:andesite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:012 | minecraft:double_stone_block_slab3 | 12 | minecraft:diorite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:013 | minecraft:double_stone_block_slab3 | 13 | minecraft:polished_diorite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:014 | minecraft:double_stone_block_slab3 | 14 | minecraft:granite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab3:015 | minecraft:double_stone_block_slab3 | 15 | minecraft:polished_granite_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:000 | minecraft:double_stone_block_slab4 | 0 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:001 | minecraft:double_stone_block_slab4 | 1 | minecraft:smooth_quartz_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:002 | minecraft:double_stone_block_slab4 | 2 | minecraft:normal_stone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:003 | minecraft:double_stone_block_slab4 | 3 | minecraft:cut_sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:004 | minecraft:double_stone_block_slab4 | 4 | minecraft:cut_red_sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:005 | minecraft:double_stone_block_slab4 | 5 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:006 | minecraft:double_stone_block_slab4 | 6 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:007 | minecraft:double_stone_block_slab4 | 7 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab4:008 | minecraft:double_stone_block_slab4 | 8 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:009 | minecraft:double_stone_block_slab4 | 9 | minecraft:smooth_quartz_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:010 | minecraft:double_stone_block_slab4 | 10 | minecraft:normal_stone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:011 | minecraft:double_stone_block_slab4 | 11 | minecraft:cut_sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:012 | minecraft:double_stone_block_slab4 | 12 | minecraft:cut_red_sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:013 | minecraft:double_stone_block_slab4 | 13 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:014 | minecraft:double_stone_block_slab4 | 14 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab4:015 | minecraft:double_stone_block_slab4 | 15 | minecraft:mossy_stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:000 | minecraft:double_stone_block_slab | 0 | minecraft:smooth_stone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:001 | minecraft:double_stone_block_slab | 1 | minecraft:sandstone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:002 | minecraft:double_stone_block_slab | 2 | minecraft:petrified_oak_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:003 | minecraft:double_stone_block_slab | 3 | minecraft:cobblestone_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:004 | minecraft:double_stone_block_slab | 4 | minecraft:brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:005 | minecraft:double_stone_block_slab | 5 | minecraft:stone_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:006 | minecraft:double_stone_block_slab | 6 | minecraft:quartz_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:007 | minecraft:double_stone_block_slab | 7 | minecraft:nether_brick_double_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:double_stone_block_slab:008 | minecraft:double_stone_block_slab | 8 | minecraft:smooth_stone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:009 | minecraft:double_stone_block_slab | 9 | minecraft:sandstone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:010 | minecraft:double_stone_block_slab | 10 | minecraft:petrified_oak_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:011 | minecraft:double_stone_block_slab | 11 | minecraft:cobblestone_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:012 | minecraft:double_stone_block_slab | 12 | minecraft:brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:013 | minecraft:double_stone_block_slab | 13 | minecraft:stone_brick_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:014 | minecraft:double_stone_block_slab | 14 | minecraft:quartz_double_slab ["minecraft:vertical_half" = "top"] |
| minecraft:double_stone_block_slab:015 | minecraft:double_stone_block_slab | 15 | minecraft:nether_brick_double_slab ["minecraft:vertical_half" = "top"] |
...
| minecraft:end_rod:006 | minecraft:end_rod | 6 | minecraft:light_block_14 |
| minecraft:end_rod:007 | minecraft:end_rod | 7 | minecraft:light_block_14 |
...
| minecraft:fence_gate:000 | minecraft:fence_gate | 0 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:fence_gate:001 | minecraft:fence_gate | 1 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:fence_gate:002 | minecraft:fence_gate | 2 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:fence_gate:003 | minecraft:fence_gate | 3 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:fence_gate:004 | minecraft:fence_gate | 4 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:fence_gate:005 | minecraft:fence_gate | 5 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:fence_gate:006 | minecraft:fence_gate | 6 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:fence_gate:007 | minecraft:fence_gate | 7 | minecraft:fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:fence_gate:008 | minecraft:fence_gate | 8 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:fence_gate:009 | minecraft:fence_gate | 9 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:fence_gate:010 | minecraft:fence_gate | 10 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:fence_gate:011 | minecraft:fence_gate | 11 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:fence_gate:012 | minecraft:fence_gate | 12 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:fence_gate:013 | minecraft:fence_gate | 13 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:fence_gate:014 | minecraft:fence_gate | 14 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:fence_gate:015 | minecraft:fence_gate | 15 | minecraft:fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:iron_chain:000 | minecraft:iron_chain | 0 | minecraft:iron_chain ["pillar_axis" = "y"] |
| minecraft:iron_chain:001 | minecraft:iron_chain | 1 | minecraft:iron_chain ["pillar_axis" = "x"] |
| minecraft:iron_chain:002 | minecraft:iron_chain | 2 | minecraft:iron_chain ["pillar_axis" = "z"] |
| minecraft:iron_door:000 | minecraft:iron_door | 0 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:001 | minecraft:iron_door | 1 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:002 | minecraft:iron_door | 2 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:003 | minecraft:iron_door | 3 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:004 | minecraft:iron_door | 4 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:005 | minecraft:iron_door | 5 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:006 | minecraft:iron_door | 6 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:007 | minecraft:iron_door | 7 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:008 | minecraft:iron_door | 8 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:009 | minecraft:iron_door | 9 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:010 | minecraft:iron_door | 10 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:011 | minecraft:iron_door | 11 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:012 | minecraft:iron_door | 12 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:013 | minecraft:iron_door | 13 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:014 | minecraft:iron_door | 14 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:015 | minecraft:iron_door | 15 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:016 | minecraft:iron_door | 16 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:017 | minecraft:iron_door | 17 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:018 | minecraft:iron_door | 18 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:019 | minecraft:iron_door | 19 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:iron_door:020 | minecraft:iron_door | 20 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:021 | minecraft:iron_door | 21 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:022 | minecraft:iron_door | 22 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:023 | minecraft:iron_door | 23 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:iron_door:024 | minecraft:iron_door | 24 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:025 | minecraft:iron_door | 25 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:026 | minecraft:iron_door | 26 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:027 | minecraft:iron_door | 27 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:iron_door:028 | minecraft:iron_door | 28 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:029 | minecraft:iron_door | 29 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:030 | minecraft:iron_door | 30 | minecraft:iron_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:iron_door:031 | minecraft:iron_door | 31 | minecraft:iron_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
...
| minecraft:jungle_door:000 | minecraft:jungle_door | 0 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:001 | minecraft:jungle_door | 1 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:002 | minecraft:jungle_door | 2 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:003 | minecraft:jungle_door | 3 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:004 | minecraft:jungle_door | 4 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:005 | minecraft:jungle_door | 5 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:006 | minecraft:jungle_door | 6 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:007 | minecraft:jungle_door | 7 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:008 | minecraft:jungle_door | 8 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:009 | minecraft:jungle_door | 9 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:010 | minecraft:jungle_door | 10 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:011 | minecraft:jungle_door | 11 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:012 | minecraft:jungle_door | 12 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:013 | minecraft:jungle_door | 13 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:014 | minecraft:jungle_door | 14 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:015 | minecraft:jungle_door | 15 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:016 | minecraft:jungle_door | 16 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:017 | minecraft:jungle_door | 17 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:018 | minecraft:jungle_door | 18 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:019 | minecraft:jungle_door | 19 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:jungle_door:020 | minecraft:jungle_door | 20 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:021 | minecraft:jungle_door | 21 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:022 | minecraft:jungle_door | 22 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:023 | minecraft:jungle_door | 23 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:jungle_door:024 | minecraft:jungle_door | 24 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:025 | minecraft:jungle_door | 25 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:026 | minecraft:jungle_door | 26 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:027 | minecraft:jungle_door | 27 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:jungle_door:028 | minecraft:jungle_door | 28 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:029 | minecraft:jungle_door | 29 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:030 | minecraft:jungle_door | 30 | minecraft:jungle_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_door:031 | minecraft:jungle_door | 31 | minecraft:jungle_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:jungle_fence_gate:000 | minecraft:jungle_fence_gate | 0 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:jungle_fence_gate:001 | minecraft:jungle_fence_gate | 1 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:jungle_fence_gate:002 | minecraft:jungle_fence_gate | 2 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:jungle_fence_gate:003 | minecraft:jungle_fence_gate | 3 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:jungle_fence_gate:004 | minecraft:jungle_fence_gate | 4 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:jungle_fence_gate:005 | minecraft:jungle_fence_gate | 5 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:jungle_fence_gate:006 | minecraft:jungle_fence_gate | 6 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:jungle_fence_gate:007 | minecraft:jungle_fence_gate | 7 | minecraft:jungle_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:jungle_fence_gate:008 | minecraft:jungle_fence_gate | 8 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:jungle_fence_gate:009 | minecraft:jungle_fence_gate | 9 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:jungle_fence_gate:010 | minecraft:jungle_fence_gate | 10 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:jungle_fence_gate:011 | minecraft:jungle_fence_gate | 11 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:jungle_fence_gate:012 | minecraft:jungle_fence_gate | 12 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:jungle_fence_gate:013 | minecraft:jungle_fence_gate | 13 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:jungle_fence_gate:014 | minecraft:jungle_fence_gate | 14 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:jungle_fence_gate:015 | minecraft:jungle_fence_gate | 15 | minecraft:jungle_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:leaves2:000 | minecraft:leaves2 | 0 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves2:001 | minecraft:leaves2 | 1 | minecraft:dark_oak_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves2:002 | minecraft:leaves2 | 2 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves2:003 | minecraft:leaves2 | 3 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves2:004 | minecraft:leaves2 | 4 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves2:005 | minecraft:leaves2 | 5 | minecraft:dark_oak_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves2:006 | minecraft:leaves2 | 6 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves2:007 | minecraft:leaves2 | 7 | minecraft:acacia_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves2:008 | minecraft:leaves2 | 8 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves2:009 | minecraft:leaves2 | 9 | minecraft:dark_oak_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves2:010 | minecraft:leaves2 | 10 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves2:011 | minecraft:leaves2 | 11 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves2:012 | minecraft:leaves2 | 12 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves2:013 | minecraft:leaves2 | 13 | minecraft:dark_oak_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves2:014 | minecraft:leaves2 | 14 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves2:015 | minecraft:leaves2 | 15 | minecraft:acacia_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves:000 | minecraft:leaves | 0 | minecraft:oak_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves:001 | minecraft:leaves | 1 | minecraft:spruce_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves:002 | minecraft:leaves | 2 | minecraft:birch_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves:003 | minecraft:leaves | 3 | minecraft:jungle_leaves ["persistent_bit" = 0, "update_bit" = 0] |
| minecraft:leaves:004 | minecraft:leaves | 4 | minecraft:oak_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves:005 | minecraft:leaves | 5 | minecraft:spruce_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves:006 | minecraft:leaves | 6 | minecraft:birch_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves:007 | minecraft:leaves | 7 | minecraft:jungle_leaves ["persistent_bit" = 0, "update_bit" = 1] |
| minecraft:leaves:008 | minecraft:leaves | 8 | minecraft:oak_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves:009 | minecraft:leaves | 9 | minecraft:spruce_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves:010 | minecraft:leaves | 10 | minecraft:birch_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves:011 | minecraft:leaves | 11 | minecraft:jungle_leaves ["persistent_bit" = 1, "update_bit" = 0] |
| minecraft:leaves:012 | minecraft:leaves | 12 | minecraft:oak_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves:013 | minecraft:leaves | 13 | minecraft:spruce_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves:014 | minecraft:leaves | 14 | minecraft:birch_leaves ["persistent_bit" = 1, "update_bit" = 1] |
| minecraft:leaves:015 | minecraft:leaves | 15 | minecraft:jungle_leaves ["persistent_bit" = 1, "update_bit" = 1] |
...
| minecraft:light_block:000 | minecraft:light_block | 0 | minecraft:light_block_0 |
| minecraft:light_block:001 | minecraft:light_block | 1 | minecraft:light_block_1 |
| minecraft:light_block:002 | minecraft:light_block | 2 | minecraft:light_block_2 |
| minecraft:light_block:003 | minecraft:light_block | 3 | minecraft:light_block_3 |
| minecraft:light_block:004 | minecraft:light_block | 4 | minecraft:light_block_4 |
| minecraft:light_block:005 | minecraft:light_block | 5 | minecraft:light_block_5 |
| minecraft:light_block:006 | minecraft:light_block | 6 | minecraft:light_block_6 |
| minecraft:light_block:007 | minecraft:light_block | 7 | minecraft:light_block_7 |
| minecraft:light_block:008 | minecraft:light_block | 8 | minecraft:light_block_8 |
| minecraft:light_block:009 | minecraft:light_block | 9 | minecraft:light_block_9 |
| minecraft:light_block:010 | minecraft:light_block | 10 | minecraft:light_block_10 |
| minecraft:light_block:011 | minecraft:light_block | 11 | minecraft:light_block_11 |
| minecraft:light_block:012 | minecraft:light_block | 12 | minecraft:light_block_12 |
| minecraft:light_block:013 | minecraft:light_block | 13 | minecraft:light_block_13 |
| minecraft:light_block:014 | minecraft:light_block | 14 | minecraft:light_block_14 |
| minecraft:light_block:015 | minecraft:light_block | 15 | minecraft:light_block_15 |
...
| minecraft:log2:012 | minecraft:log2 | 12 | minecraft:acacia_wood ["pillar_axis" = "y"] |
| minecraft:log2:013 | minecraft:log2 | 13 | minecraft:dark_oak_wood ["pillar_axis" = "y"] |
| minecraft:log2:014 | minecraft:log2 | 14 | minecraft:acacia_wood ["pillar_axis" = "y"] |
| minecraft:log2:015 | minecraft:log2 | 15 | minecraft:acacia_wood ["pillar_axis" = "y"] |
...
| minecraft:log:012 | minecraft:log | 12 | minecraft:oak_wood ["pillar_axis" = "y"] |
| minecraft:log:013 | minecraft:log | 13 | minecraft:spruce_wood ["pillar_axis" = "y"] |
| minecraft:log:014 | minecraft:log | 14 | minecraft:birch_wood ["pillar_axis" = "y"] |
| minecraft:log:015 | minecraft:log | 15 | minecraft:jungle_wood ["pillar_axis" = "y"] |
...
| minecraft:mangrove_door:000 | minecraft:mangrove_door | 0 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:001 | minecraft:mangrove_door | 1 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:002 | minecraft:mangrove_door | 2 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:003 | minecraft:mangrove_door | 3 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:004 | minecraft:mangrove_door | 4 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:005 | minecraft:mangrove_door | 5 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:006 | minecraft:mangrove_door | 6 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:007 | minecraft:mangrove_door | 7 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:008 | minecraft:mangrove_door | 8 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:009 | minecraft:mangrove_door | 9 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:010 | minecraft:mangrove_door | 10 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:011 | minecraft:mangrove_door | 11 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:012 | minecraft:mangrove_door | 12 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:013 | minecraft:mangrove_door | 13 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:014 | minecraft:mangrove_door | 14 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:015 | minecraft:mangrove_door | 15 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:016 | minecraft:mangrove_door | 16 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:017 | minecraft:mangrove_door | 17 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:018 | minecraft:mangrove_door | 18 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:019 | minecraft:mangrove_door | 19 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:mangrove_door:020 | minecraft:mangrove_door | 20 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:021 | minecraft:mangrove_door | 21 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:022 | minecraft:mangrove_door | 22 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:023 | minecraft:mangrove_door | 23 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:mangrove_door:024 | minecraft:mangrove_door | 24 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:025 | minecraft:mangrove_door | 25 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:026 | minecraft:mangrove_door | 26 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:027 | minecraft:mangrove_door | 27 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:mangrove_door:028 | minecraft:mangrove_door | 28 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:029 | minecraft:mangrove_door | 29 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:030 | minecraft:mangrove_door | 30 | minecraft:mangrove_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_door:031 | minecraft:mangrove_door | 31 | minecraft:mangrove_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:mangrove_fence_gate:000 | minecraft:mangrove_fence_gate | 0 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:001 | minecraft:mangrove_fence_gate | 1 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:002 | minecraft:mangrove_fence_gate | 2 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:003 | minecraft:mangrove_fence_gate | 3 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:004 | minecraft:mangrove_fence_gate | 4 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:005 | minecraft:mangrove_fence_gate | 5 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:006 | minecraft:mangrove_fence_gate | 6 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:007 | minecraft:mangrove_fence_gate | 7 | minecraft:mangrove_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:008 | minecraft:mangrove_fence_gate | 8 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:009 | minecraft:mangrove_fence_gate | 9 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:010 | minecraft:mangrove_fence_gate | 10 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:011 | minecraft:mangrove_fence_gate | 11 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:mangrove_fence_gate:012 | minecraft:mangrove_fence_gate | 12 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:013 | minecraft:mangrove_fence_gate | 13 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:014 | minecraft:mangrove_fence_gate | 14 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:mangrove_fence_gate:015 | minecraft:mangrove_fence_gate | 15 | minecraft:mangrove_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:monster_egg:000 | minecraft:monster_egg | 0 | minecraft:infested_stone |
| minecraft:monster_egg:001 | minecraft:monster_egg | 1 | minecraft:infested_cobblestone |
| minecraft:monster_egg:002 | minecraft:monster_egg | 2 | minecraft:infested_stone_bricks |
| minecraft:monster_egg:003 | minecraft:monster_egg | 3 | minecraft:infested_mossy_stone_bricks |
| minecraft:monster_egg:004 | minecraft:monster_egg | 4 | minecraft:infested_cracked_stone_bricks |
| minecraft:monster_egg:005 | minecraft:monster_egg | 5 | minecraft:infested_chiseled_stone_bricks |
| minecraft:monster_egg:006 | minecraft:monster_egg | 6 | minecraft:infested_stone |
| minecraft:monster_egg:007 | minecraft:monster_egg | 7 | minecraft:infested_stone |
...
| minecraft:prismarine:000 | minecraft:prismarine | 0 | minecraft:prismarine |
| minecraft:prismarine:001 | minecraft:prismarine | 1 | minecraft:dark_prismarine |
| minecraft:prismarine:002 | minecraft:prismarine | 2 | minecraft:prismarine_bricks |
| minecraft:prismarine:003 | minecraft:prismarine | 3 | minecraft:prismarine |
...
| minecraft:quartz_block:000 | minecraft:quartz_block | 0 | minecraft:quartz_block ["pillar_axis" = "y"] |
| minecraft:quartz_block:001 | minecraft:quartz_block | 1 | minecraft:chiseled_quartz_block ["pillar_axis" = "y"] |
| minecraft:quartz_block:002 | minecraft:quartz_block | 2 | minecraft:quartz_pillar ["pillar_axis" = "y"] |
| minecraft:quartz_block:003 | minecraft:quartz_block | 3 | minecraft:smooth_quartz ["pillar_axis" = "y"] |
| minecraft:quartz_block:004 | minecraft:quartz_block | 4 | minecraft:quartz_block ["pillar_axis" = "x"] |
| minecraft:quartz_block:005 | minecraft:quartz_block | 5 | minecraft:chiseled_quartz_block ["pillar_axis" = "x"] |
| minecraft:quartz_block:006 | minecraft:quartz_block | 6 | minecraft:quartz_pillar ["pillar_axis" = "x"] |
| minecraft:quartz_block:007 | minecraft:quartz_block | 7 | minecraft:smooth_quartz ["pillar_axis" = "x"] |
| minecraft:quartz_block:008 | minecraft:quartz_block | 8 | minecraft:quartz_block ["pillar_axis" = "z"] |
| minecraft:quartz_block:009 | minecraft:quartz_block | 9 | minecraft:chiseled_quartz_block ["pillar_axis" = "z"] |
| minecraft:quartz_block:010 | minecraft:quartz_block | 10 | minecraft:quartz_pillar ["pillar_axis" = "z"] |
| minecraft:quartz_block:011 | minecraft:quartz_block | 11 | minecraft:smooth_quartz ["pillar_axis" = "z"] |
| minecraft:quartz_block:012 | minecraft:quartz_block | 12 | minecraft:quartz_block ["pillar_axis" = "y"] |
| minecraft:quartz_block:013 | minecraft:quartz_block | 13 | minecraft:chiseled_quartz_block ["pillar_axis" = "y"] |
| minecraft:quartz_block:014 | minecraft:quartz_block | 14 | minecraft:quartz_pillar ["pillar_axis" = "y"] |
| minecraft:quartz_block:015 | minecraft:quartz_block | 15 | minecraft:smooth_quartz ["pillar_axis" = "y"] |
...
| minecraft:red_flower:000 | minecraft:red_flower | 0 | minecraft:poppy |
| minecraft:red_flower:001 | minecraft:red_flower | 1 | minecraft:blue_orchid |
| minecraft:red_flower:002 | minecraft:red_flower | 2 | minecraft:allium |
| minecraft:red_flower:003 | minecraft:red_flower | 3 | minecraft:azure_bluet |
| minecraft:red_flower:004 | minecraft:red_flower | 4 | minecraft:red_tulip |
| minecraft:red_flower:005 | minecraft:red_flower | 5 | minecraft:orange_tulip |
| minecraft:red_flower:006 | minecraft:red_flower | 6 | minecraft:white_tulip |
| minecraft:red_flower:007 | minecraft:red_flower | 7 | minecraft:pink_tulip |
| minecraft:red_flower:008 | minecraft:red_flower | 8 | minecraft:oxeye_daisy |
| minecraft:red_flower:009 | minecraft:red_flower | 9 | minecraft:cornflower |
| minecraft:red_flower:010 | minecraft:red_flower | 10 | minecraft:lily_of_the_valley |
| minecraft:red_flower:011 | minecraft:red_flower | 11 | minecraft:poppy |
| minecraft:red_flower:012 | minecraft:red_flower | 12 | minecraft:poppy |
| minecraft:red_flower:013 | minecraft:red_flower | 13 | minecraft:poppy |
| minecraft:red_flower:014 | minecraft:red_flower | 14 | minecraft:poppy |
| minecraft:red_flower:015 | minecraft:red_flower | 15 | minecraft:poppy |
...
| minecraft:red_mushroom_block:010 | minecraft:red_mushroom_block | 10 | minecraft:mushroom_stem ["huge_mushroom_bits" = 10] |
...
| minecraft:red_mushroom_block:015 | minecraft:red_mushroom_block | 15 | minecraft:mushroom_stem ["huge_mushroom_bits" = 15] |
...
| minecraft:red_sandstone:000 | minecraft:red_sandstone | 0 | minecraft:red_sandstone |
| minecraft:red_sandstone:001 | minecraft:red_sandstone | 1 | minecraft:chiseled_red_sandstone |
| minecraft:red_sandstone:002 | minecraft:red_sandstone | 2 | minecraft:cut_red_sandstone |
| minecraft:red_sandstone:003 | minecraft:red_sandstone | 3 | minecraft:smooth_red_sandstone |
...
| minecraft:sand:000 | minecraft:sand | 0 | minecraft:sand |
| minecraft:sand:001 | minecraft:sand | 1 | minecraft:red_sand |
| minecraft:sandstone:000 | minecraft:sandstone | 0 | minecraft:sandstone |
| minecraft:sandstone:001 | minecraft:sandstone | 1 | minecraft:chiseled_sandstone |
| minecraft:sandstone:002 | minecraft:sandstone | 2 | minecraft:cut_sandstone |
| minecraft:sandstone:003 | minecraft:sandstone | 3 | minecraft:smooth_sandstone |
...
| minecraft:spruce_door:000 | minecraft:spruce_door | 0 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:001 | minecraft:spruce_door | 1 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:002 | minecraft:spruce_door | 2 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:003 | minecraft:spruce_door | 3 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:004 | minecraft:spruce_door | 4 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:005 | minecraft:spruce_door | 5 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:006 | minecraft:spruce_door | 6 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:007 | minecraft:spruce_door | 7 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:008 | minecraft:spruce_door | 8 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:009 | minecraft:spruce_door | 9 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:010 | minecraft:spruce_door | 10 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:011 | minecraft:spruce_door | 11 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:012 | minecraft:spruce_door | 12 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:013 | minecraft:spruce_door | 13 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:014 | minecraft:spruce_door | 14 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:015 | minecraft:spruce_door | 15 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:016 | minecraft:spruce_door | 16 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:017 | minecraft:spruce_door | 17 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:018 | minecraft:spruce_door | 18 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:019 | minecraft:spruce_door | 19 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:spruce_door:020 | minecraft:spruce_door | 20 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:021 | minecraft:spruce_door | 21 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:022 | minecraft:spruce_door | 22 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:023 | minecraft:spruce_door | 23 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:spruce_door:024 | minecraft:spruce_door | 24 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:025 | minecraft:spruce_door | 25 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:026 | minecraft:spruce_door | 26 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:027 | minecraft:spruce_door | 27 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:spruce_door:028 | minecraft:spruce_door | 28 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:029 | minecraft:spruce_door | 29 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:030 | minecraft:spruce_door | 30 | minecraft:spruce_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_door:031 | minecraft:spruce_door | 31 | minecraft:spruce_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:spruce_fence_gate:000 | minecraft:spruce_fence_gate | 0 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:spruce_fence_gate:001 | minecraft:spruce_fence_gate | 1 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:spruce_fence_gate:002 | minecraft:spruce_fence_gate | 2 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:spruce_fence_gate:003 | minecraft:spruce_fence_gate | 3 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:spruce_fence_gate:004 | minecraft:spruce_fence_gate | 4 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:spruce_fence_gate:005 | minecraft:spruce_fence_gate | 5 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:spruce_fence_gate:006 | minecraft:spruce_fence_gate | 6 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:spruce_fence_gate:007 | minecraft:spruce_fence_gate | 7 | minecraft:spruce_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:spruce_fence_gate:008 | minecraft:spruce_fence_gate | 8 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:spruce_fence_gate:009 | minecraft:spruce_fence_gate | 9 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:spruce_fence_gate:010 | minecraft:spruce_fence_gate | 10 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:spruce_fence_gate:011 | minecraft:spruce_fence_gate | 11 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:spruce_fence_gate:012 | minecraft:spruce_fence_gate | 12 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:spruce_fence_gate:013 | minecraft:spruce_fence_gate | 13 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:spruce_fence_gate:014 | minecraft:spruce_fence_gate | 14 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:spruce_fence_gate:015 | minecraft:spruce_fence_gate | 15 | minecraft:spruce_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:stone_block_slab2:000 | minecraft:stone_block_slab2 | 0 | minecraft:red_sandstone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:001 | minecraft:stone_block_slab2 | 1 | minecraft:purpur_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:002 | minecraft:stone_block_slab2 | 2 | minecraft:prismarine_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:003 | minecraft:stone_block_slab2 | 3 | minecraft:dark_prismarine_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:004 | minecraft:stone_block_slab2 | 4 | minecraft:prismarine_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:005 | minecraft:stone_block_slab2 | 5 | minecraft:mossy_cobblestone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:006 | minecraft:stone_block_slab2 | 6 | minecraft:smooth_sandstone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:007 | minecraft:stone_block_slab2 | 7 | minecraft:red_nether_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab2:008 | minecraft:stone_block_slab2 | 8 | minecraft:red_sandstone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:009 | minecraft:stone_block_slab2 | 9 | minecraft:purpur_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:010 | minecraft:stone_block_slab2 | 10 | minecraft:prismarine_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:011 | minecraft:stone_block_slab2 | 11 | minecraft:dark_prismarine_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:012 | minecraft:stone_block_slab2 | 12 | minecraft:prismarine_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:013 | minecraft:stone_block_slab2 | 13 | minecraft:mossy_cobblestone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:014 | minecraft:stone_block_slab2 | 14 | minecraft:smooth_sandstone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab2:015 | minecraft:stone_block_slab2 | 15 | minecraft:red_nether_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:000 | minecraft:stone_block_slab3 | 0 | minecraft:end_stone_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:001 | minecraft:stone_block_slab3 | 1 | minecraft:smooth_red_sandstone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:002 | minecraft:stone_block_slab3 | 2 | minecraft:polished_andesite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:003 | minecraft:stone_block_slab3 | 3 | minecraft:andesite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:004 | minecraft:stone_block_slab3 | 4 | minecraft:diorite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:005 | minecraft:stone_block_slab3 | 5 | minecraft:polished_diorite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:006 | minecraft:stone_block_slab3 | 6 | minecraft:granite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:007 | minecraft:stone_block_slab3 | 7 | minecraft:polished_granite_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab3:008 | minecraft:stone_block_slab3 | 8 | minecraft:end_stone_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:009 | minecraft:stone_block_slab3 | 9 | minecraft:smooth_red_sandstone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:010 | minecraft:stone_block_slab3 | 10 | minecraft:polished_andesite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:011 | minecraft:stone_block_slab3 | 11 | minecraft:andesite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:012 | minecraft:stone_block_slab3 | 12 | minecraft:diorite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:013 | minecraft:stone_block_slab3 | 13 | minecraft:polished_diorite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:014 | minecraft:stone_block_slab3 | 14 | minecraft:granite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab3:015 | minecraft:stone_block_slab3 | 15 | minecraft:polished_granite_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:000 | minecraft:stone_block_slab4 | 0 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:001 | minecraft:stone_block_slab4 | 1 | minecraft:smooth_quartz_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:002 | minecraft:stone_block_slab4 | 2 | minecraft:normal_stone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:003 | minecraft:stone_block_slab4 | 3 | minecraft:cut_sandstone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:004 | minecraft:stone_block_slab4 | 4 | minecraft:cut_red_sandstone_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:005 | minecraft:stone_block_slab4 | 5 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:006 | minecraft:stone_block_slab4 | 6 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:007 | minecraft:stone_block_slab4 | 7 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "bottom"] |
| minecraft:stone_block_slab4:008 | minecraft:stone_block_slab4 | 8 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:009 | minecraft:stone_block_slab4 | 9 | minecraft:smooth_quartz_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:010 | minecraft:stone_block_slab4 | 10 | minecraft:normal_stone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:011 | minecraft:stone_block_slab4 | 11 | minecraft:cut_sandstone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:012 | minecraft:stone_block_slab4 | 12 | minecraft:cut_red_sandstone_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:013 | minecraft:stone_block_slab4 | 13 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:014 | minecraft:stone_block_slab4 | 14 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "top"] |
| minecraft:stone_block_slab4:015 | minecraft:stone_block_slab4 | 15 | minecraft:mossy_stone_brick_slab ["minecraft:vertical_half" = "top"] |
...
| minecraft:stone_block_slab:012 | minecraft:stone_block_slab | 12 | minecraft:brick_slab ["minecraft:vertical_half" = "top"] |
...
| minecraft:stonebrick:000 | minecraft:stonebrick | 0 | minecraft:stone_bricks |
| minecraft:stonebrick:001 | minecraft:stonebrick | 1 | minecraft:mossy_stone_bricks |
| minecraft:stonebrick:002 | minecraft:stonebrick | 2 | minecraft:cracked_stone_bricks |
| minecraft:stonebrick:003 | minecraft:stonebrick | 3 | minecraft:chiseled_stone_bricks |
| minecraft:stonebrick:004 | minecraft:stonebrick | 4 | minecraft:stone_bricks |
| minecraft:stonebrick:005 | minecraft:stonebrick | 5 | minecraft:stone_bricks |
| minecraft:stonebrick:006 | minecraft:stonebrick | 6 | minecraft:stone_bricks |
| minecraft:stonebrick:007 | minecraft:stonebrick | 7 | minecraft:stone_bricks |
...
| minecraft:warped_door:000 | minecraft:warped_door | 0 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:001 | minecraft:warped_door | 1 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:002 | minecraft:warped_door | 2 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:003 | minecraft:warped_door | 3 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:004 | minecraft:warped_door | 4 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:005 | minecraft:warped_door | 5 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:006 | minecraft:warped_door | 6 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:007 | minecraft:warped_door | 7 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:008 | minecraft:warped_door | 8 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:009 | minecraft:warped_door | 9 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:010 | minecraft:warped_door | 10 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:011 | minecraft:warped_door | 11 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:012 | minecraft:warped_door | 12 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:013 | minecraft:warped_door | 13 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:014 | minecraft:warped_door | 14 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:015 | minecraft:warped_door | 15 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:016 | minecraft:warped_door | 16 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:017 | minecraft:warped_door | 17 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:018 | minecraft:warped_door | 18 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:019 | minecraft:warped_door | 19 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:warped_door:020 | minecraft:warped_door | 20 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:021 | minecraft:warped_door | 21 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:022 | minecraft:warped_door | 22 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:023 | minecraft:warped_door | 23 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:warped_door:024 | minecraft:warped_door | 24 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:025 | minecraft:warped_door | 25 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:026 | minecraft:warped_door | 26 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:027 | minecraft:warped_door | 27 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:warped_door:028 | minecraft:warped_door | 28 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:029 | minecraft:warped_door | 29 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:030 | minecraft:warped_door | 30 | minecraft:warped_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_door:031 | minecraft:warped_door | 31 | minecraft:warped_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:warped_fence_gate:000 | minecraft:warped_fence_gate | 0 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:warped_fence_gate:001 | minecraft:warped_fence_gate | 1 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:warped_fence_gate:002 | minecraft:warped_fence_gate | 2 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:warped_fence_gate:003 | minecraft:warped_fence_gate | 3 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:warped_fence_gate:004 | minecraft:warped_fence_gate | 4 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:warped_fence_gate:005 | minecraft:warped_fence_gate | 5 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:warped_fence_gate:006 | minecraft:warped_fence_gate | 6 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:warped_fence_gate:007 | minecraft:warped_fence_gate | 7 | minecraft:warped_fence_gate ["in_wall_bit" = 0, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
| minecraft:warped_fence_gate:008 | minecraft:warped_fence_gate | 8 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 0] |
| minecraft:warped_fence_gate:009 | minecraft:warped_fence_gate | 9 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0] |
| minecraft:warped_fence_gate:010 | minecraft:warped_fence_gate | 10 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 0] |
| minecraft:warped_fence_gate:011 | minecraft:warped_fence_gate | 11 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0] |
| minecraft:warped_fence_gate:012 | minecraft:warped_fence_gate | 12 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "south", "open_bit" = 1] |
| minecraft:warped_fence_gate:013 | minecraft:warped_fence_gate | 13 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1] |
| minecraft:warped_fence_gate:014 | minecraft:warped_fence_gate | 14 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "north", "open_bit" = 1] |
| minecraft:warped_fence_gate:015 | minecraft:warped_fence_gate | 15 | minecraft:warped_fence_gate ["in_wall_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1] |
...
| minecraft:wood:000 | minecraft:wood | 0 | minecraft:oak_wood |
| minecraft:wood:001 | minecraft:wood | 1 | minecraft:spruce_wood |
| minecraft:wood:002 | minecraft:wood | 2 | minecraft:birch_wood |
| minecraft:wood:003 | minecraft:wood | 3 | minecraft:jungle_wood |
| minecraft:wood:004 | minecraft:wood | 4 | minecraft:acacia_wood |
| minecraft:wood:005 | minecraft:wood | 5 | minecraft:dark_oak_wood |
| minecraft:wood:006 | minecraft:wood | 6 | minecraft:oak_wood |
| minecraft:wood:007 | minecraft:wood | 7 | minecraft:oak_wood |
| minecraft:wood:008 | minecraft:wood | 8 | minecraft:stripped_oak_wood |
| minecraft:wood:009 | minecraft:wood | 9 | minecraft:stripped_spruce_wood |
| minecraft:wood:010 | minecraft:wood | 10 | minecraft:stripped_birch_wood |
| minecraft:wood:011 | minecraft:wood | 11 | minecraft:stripped_jungle_wood |
| minecraft:wood:012 | minecraft:wood | 12 | minecraft:stripped_acacia_wood |
| minecraft:wood:013 | minecraft:wood | 13 | minecraft:stripped_dark_oak_wood |
| minecraft:wood:014 | minecraft:wood | 14 | minecraft:stripped_oak_wood |
| minecraft:wood:015 | minecraft:wood | 15 | minecraft:stripped_oak_wood |
...
| minecraft:wooden_door:000 | minecraft:wooden_door | 0 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:001 | minecraft:wooden_door | 1 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:002 | minecraft:wooden_door | 2 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:003 | minecraft:wooden_door | 3 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:004 | minecraft:wooden_door | 4 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:005 | minecraft:wooden_door | 5 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:006 | minecraft:wooden_door | 6 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:007 | minecraft:wooden_door | 7 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:008 | minecraft:wooden_door | 8 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:009 | minecraft:wooden_door | 9 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:010 | minecraft:wooden_door | 10 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:011 | minecraft:wooden_door | 11 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:012 | minecraft:wooden_door | 12 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:013 | minecraft:wooden_door | 13 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:014 | minecraft:wooden_door | 14 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:015 | minecraft:wooden_door | 15 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:016 | minecraft:wooden_door | 16 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:017 | minecraft:wooden_door | 17 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:018 | minecraft:wooden_door | 18 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:019 | minecraft:wooden_door | 19 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 0] |
| minecraft:wooden_door:020 | minecraft:wooden_door | 20 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:021 | minecraft:wooden_door | 21 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:022 | minecraft:wooden_door | 22 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:023 | minecraft:wooden_door | 23 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 0] |
| minecraft:wooden_door:024 | minecraft:wooden_door | 24 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:025 | minecraft:wooden_door | 25 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:026 | minecraft:wooden_door | 26 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:027 | minecraft:wooden_door | 27 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 0, "upper_block_bit" = 1] |
| minecraft:wooden_door:028 | minecraft:wooden_door | 28 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "south", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:029 | minecraft:wooden_door | 29 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "west", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:030 | minecraft:wooden_door | 30 | minecraft:wooden_door ["door_hinge_bit" = 0, "minecraft:cardinal_direction" = "north", "open_bit" = 1, "upper_block_bit" = 1] |
| minecraft:wooden_door:031 | minecraft:wooden_door | 31 | minecraft:wooden_door ["door_hinge_bit" = 1, "minecraft:cardinal_direction" = "east", "open_bit" = 1, "upper_block_bit" = 1] |
...
| coral_color | String | blue, pink, purple, red, yellow, blue dead, pink dead, red dead, yellow dead | DEPRECATED - Determines the color of a coral block |
| coral_direction | Integer | 0 - 3 | Describes the rotation of coral fans |
| coral_hang_type_bit | Boolean | True, False | DEPRECATED - Describes the type of hanging for coral fans |
...
| creaking_heart_state | String | uprooted, dormant, awake | Determines the block states for the Creaking Heart |
| damage | String | undamaged, slightly_damaged, very_damaged, broken | DEPRECATED - Determines the state of damage of an Anvil |
| dead_bit | Boolean | True, False | DEPRECATED - Determines if coral, coral fans, or sea pickles are dead |
| direction | Integer | 0 - 3 | Determines the North, South, East, and West direction of some blocks. 0 = South, 1 = West, 2 = North 3 = East |
| dirt_type | String | normal, coarse | DEPRECATED - Determines the dirt type of a block |
...
| monster_egg_stone_type | String | stone, cobblestone, stone_brick, mossy_stone_brick, cracked_stone_brick, chiseled_stone_brick | DEPRECATED - Determines the stone type of a monster egg block |
...
| new_log_type | String | acacia, dark_oak | DEPRECATED - Determines the wood type of some blocks |
...
| old_log_type | String | oak, spruce, birch, jungle | DEPRECATED - Determines the wood type of some blocks |
...
| rehydration_level | Integer | 0 - 3 | Determines the Dried Ghast Block's progress towards a Ghastling |
| repeater_delay | Integer | 0 - 3 | Determines the amount of delay of a repeater |
| sand_stone_type | String | default, heiroglyphs, cut, smooth | DEPRECATED - Determines the pattern of a sandstone block |
| sand_type | String | normal, red | DEPRECATED - Determines the sand type of a block |
...
| shelf_connection_type | Integer | unconnected, right, center, left | Determines the powered variant of the Shelf |
...
| stone_brick_type | String | default, mossy, cracked, chiseled, smooth | DEPRECATED - Determines the type of a stone brick block |
...
| stone_slab_type_3 | String | end_stone_brick, smooth_red_sandstone, polishe_andesite, andesite, diorite, polished_diorite, granite, polished_granite | DEPRECATED - Determines the type of some stone slab blocks |
...
| stone_type | String | stone, granite, granite_smooth, diorite, diorite_smooth, andesite, andesite_smooth | DEPRECATED - Determines the stone type of a block |
...
| wood_type | String | oak, spruce, birch, jungle, acacia, dark_oak | DEPRECATED - Determines the wood type of a block |
...
> **"minecraft:placement_position"** 子参数
