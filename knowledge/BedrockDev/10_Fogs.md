# FOGS DOCUMENTATION Version: 1.21.120.4
...
0.000000-*> // The distance from the player that the fog will become fully opaque. 'fog_end' must be greater than or equal to 'fog_start'.


string "render_distance_type"


<


"fixed", "render"> // Determines how distance value is used. Fixed distance is measured in blocks. Dynamic distance is multiplied by the current render distance.
...
0.000000-1.000000> // The minimum progress of fog transition.
...
0.000000-*> // The time takes to reach certain progress('mid_percent') of fog transition.
...
0.000000-1.000000> // The progress of fog transition after 'mid_seconds' seconds.
...
0.000000-*> // Total amount of time takes to complete fog transition.
...
0.000000-1.000000> // The maximum amount of opaqueness that the ground fog will take on. A value from [0.0, 1.0].


float "max_density_height"


<


-64.000000-320.000000> : opt // The height in blocks that the ground fog will become it's maximum density.


float "zero_density_height"


<


-64.000000-320.000000> : opt // The height in blocks that the ground fog will be completely transparent and begin to appear. This value needs to be at least 1 higher than 'max_density_height'.
