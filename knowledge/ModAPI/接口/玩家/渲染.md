...
- 备注
  ...
  - 调用该接口后需要调用[RebuildPlayerRender](#rebuildplayerrender)才会生效
...
- 备注
  ...
  - 音效在RP/entities/player.entity.json # minecraft:client_entity / description中的定义如下：
    ...
    "dripping": {
    "sound_effects": `[ { "effect": "sound_thunder" } ]`,
    "transitions": `[ { "third_person": "!query.mod.is_powered" } ]`
    },
...
- 备注
  ...
  - 还原后，对玩家使用过的actorRender组件接口（如[AddPlayerRenderController](#addplayerrendercontroller)依然生效）
